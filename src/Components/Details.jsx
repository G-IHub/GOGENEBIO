...
const Details = () => {
  return (
    <div id="how-it-works" className="px-5 md:px-10 lg:px-16 py-16 md:py-20 bg-[#f5f3fa] scroll-mt-20">
      <Reveal className="flex flex-col items-center text-center max-w-xl mx-auto mb-12 md:mb-16">
      ...
      <Reveal className="max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-stretch">
        {steps.map((step, i) => (
